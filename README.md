...
Once the `conda-forge` channel has been enabled, `msnoise` can be installed with:

```
conda install msnoise
```

It is possible to list all of the versions of `msnoise` available on your platform with:
